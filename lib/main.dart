...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
                      ...
                      return touchedSpots.map((spot) {
                        ...
                        if (monthIndex < monthlyData.length) {
                          return LineTooltipItem(
                            '${monthlyData[monthIndex]['monthName']}\n${spot.y.toStringAsFixed(1)}m',
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (double value, TitleMeta meta) {
                        ...
                        if (index >= 0 && index < monthlyData.length) {
                          return Text(
                            monthlyData[index]['monthName'].substring(0, 3),
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: monthlyData.asMap().entries.map((entry) {
                      return FlSpot(entry.key.toDouble(), entry.value['groundwaterLevel']);
                    }).toList(),
                    isCurved: true,
                    color: Colors.blue,
                    barWidth: 3,
                    ...
                    dotData: FlDotData(
                      ...
                      getDotPainter: (spot, percent, barData, index) {
                        if (index < monthlyData.length) {
                          Color dotColor = _getStatusColorByName(monthlyData[index]['status']);
  ...
  void _showCriticalAdvisory(BuildContext context, String location) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                'Critical groundwater conditions detected. Immediate action recommended:',
                style: TextStyle(
              ...
              const SizedBox(height: 12),
              _buildAdvisoryItem('💧', 'Install rainwater harvesting tanks'),
              _buildAdvisoryItem('🏗️', 'Construct recharge wells and check dams'),
              _buildAdvisoryItem('🌱', 'Implement drip irrigation systems'),
              _buildAdvisoryItem('💦', 'Reduce water consumption immediately'),
              _buildAdvisoryItem('📊', 'Monitor groundwater levels regularly'),
              const SizedBox(height: 12),
              Container(
                padding: EdgeInsets.all(12),
                decoration: BoxDecoration(
                ...
                child: Text(
                  'Goal: Move from Critical to Moderate level through these conservation measures',
                  style: TextStyle(
  ...
  Widget _buildAdvisoryItem(String emoji, String text) {
    return Padding(
          ...
          children: [
            ...
            Expanded(
              child: _buildSummaryCard('Critical', '$criticalMonths/12', Colors.red, Icons.error, 
                onTap: criticalMonths > 0 ? () => _showCriticalAdvisory(context, _searchController.text.isNotEmpty ? _searchController.text : 'Current Location') : null),
            ),
          ],
        ),
  ...
  Widget _buildSummaryCard(String title, String value, Color color, IconData icon, {VoidCallback? onTap}) {
    Widget cardContent = Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            title == 'Critical' ? 'State Level\nGroundwater\nAnalyses' : title,
            style: TextStyle(
              fontSize: title == 'Critical' ? 10 : 12,
              color: color,
            ),
        ...
        children: [
          ...
          Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                Tab(icon: Icon(Icons.search), text: 'State Level Groundwater Analyses'),
                Tab(icon: Icon(Icons.trending_up), text: 'Groundwater Level Fluctuations Upto 2035'),
                Tab(icon: Icon(Icons.water_drop), text: 'Recharge System'),
              ],
            ),
          ),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('State Level Groundwater Analyses'),
              ...
              child: Center(
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    const SizedBox(height: 16),
                    Text(
                      isLiveUpdateActive ? 'Live State Level Groundwater Analyses' : 'State Level Groundwater Analyses',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '🔄 Live updates every 30 seconds for groundwater levels',
                            style: TextStyle(
                              fontSize: 11,
  ...
  Widget _buildTamilNaduLiveChip(String city, Color statusColor) {
    ...
    return GestureDetector(
      onTap: () {
        if (status == 'Critical') {
          _showCriticalAdvisory(context, city);
        } else {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (status == 'Critical') ...[
              const SizedBox(width: 4),
              Icon(Icons.notifications_active, color: statusColor, size: 12),
            ],
          ],
        ),
      ),
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${districtData['state'] ?? 'All India'} • Real-time DWLR Data',
                          style: TextStyle(fontSize: 14, color: Colors.grey.shade600),
                        ),
              ...
              if (districtData['stations'] != null) ...[
                ...
                ...((districtData['stations'] as List<AllIndiaDWLRStation>).map((station) => 
                  GestureDetector(
                    onTap: station.levelCategory.toLowerCase() == 'critical' 
                      ? () => _showCriticalAdvisory(context, station.name)
                      : null,
                    child: Container(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                if (station.levelCategory.toLowerCase() == 'critical') ...[
                                  SizedBox(width: 4),
                          ...
                          child: LineChart(
                            LineChartData(
                              ...
                              lineBarsData: [
                                LineChartBarData(
                                  spots: [
                                    FlSpot(0, (districtData['good'] ?? 0).toDouble()),
                                    FlSpot(1, (districtData['moderate'] ?? 0).toDouble()),
                                    FlSpot(2, (districtData['critical'] ?? 0).toDouble()),
                                  ],
                                  isCurved: true,
                                  color: Colors.blue,
                                  barWidth: 4,
